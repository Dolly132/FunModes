...
methodmap RealityShift_mm
{
	...
	{
		OnClientPutInServer_RealityShift(client);
	...
	{
		OnClientDisconnect_RealityShift(client);
	...
	{
		ZR_OnClientInfected_RealityShift(client);
...
#define LAST_MODE_TYPE RealityShift_mm
