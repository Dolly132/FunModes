...
methodmap VIPMode_mm
{
	...
	{
		OnClientPutInServer_VIPMode(client);
	...
	{
		OnClientDisconnect_VIPMode(client);
	...
	{
		Event_PlayerTeam_VIPMode(event);
	...
	{
		Event_PlayerDeath_VIPMode(client);
	...
	{
		OnTakeDamage_VIPMode(victim, attacker, damage, result);
...
#define LAST_MODE_TYPE VIPMode_mm
