...
methodmap GunGame_mm
{
	...
	{
		OnClientPutInServer_GunGame(client);
	...
	{
		OnClientDisconnect_GunGame(client);
	...
	{
		ZR_OnClientInfected_GunGame(client);
	...
	{
		Event_PlayerSpawn_GunGame(client);
	...
	{
		Event_PlayerDeath_GunGame(client);
	...
	{
		OnTakeDamagePost_GunGame(victim, attacker, damage);
...
#define LAST_MODE_TYPE GunGame_mm
